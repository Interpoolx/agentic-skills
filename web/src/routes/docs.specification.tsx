...
Instructions for the AI agent...`}</CodeBlock>
      ...
      <div className="grid grid-cols-2 gap-4 my-4">
        <div>
          <p className="text-[10px] font-bold text-gray-400 mb-3 uppercase tracking-widest">✅ Valid names</p>
          <CodeBlock language="yaml">{`name: pdf-processing
name: data-analysis
name: code-review`}</CodeBlock>
        </div>
        <div>
          <p className="text-[10px] font-bold text-gray-600 mb-3 uppercase tracking-widest">❌ Invalid names</p>
...
name: pdf--processing # consecutive hyphens`}</CodeBlock>
      ...
      <div className="grid grid-cols-2 gap-4 my-4">
        <div>
          <p className="text-[10px] font-bold text-gray-400 mb-3 uppercase tracking-widest">✅ Good description</p>
...
document extraction.`}</CodeBlock>
        ...
        <div>
          <p className="text-[10px] font-bold text-gray-600 mb-3 uppercase tracking-widest">❌ Poor description</p>
...
└── sample-data.csv`}</CodeBlock>
      ...
      <p>
        Use the {BRANDING.brand_name} CLI to validate your skill before publishing:
      </p>

      <CodeBlock language="bash">{`npx ${BRANDING.brand_lower_name} validate ./my-skill
...
Checks:
  ...
  ✓ Body content present (100+ chars)`}</CodeBlock>
      ...
      <InfoBox type="tip" title="Pro Tip">
        ...
        <br />
        <code>npx {BRANDING.brand_lower_name} validate ./my-skill --strict</code>
      </InfoBox>
    </DocsLayout>
  )
}
