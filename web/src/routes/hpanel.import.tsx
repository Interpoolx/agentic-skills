    ...
    async function importFromSource(source: 'marketplace' | 'claude-plugins') {
        ...
        try {
            ...
            if (source === 'marketplace') {
                const res = await fetch(`https://raw.githubusercontent.com/${BRANDING.github_org}/${BRANDING.github_repo}/main/marketplace.json`)
                ...
                <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-gray-500 text-xs mt-2">Source: github.com/${BRANDING.github_org}/${BRANDING.github_repo}/marketplace.json</p>
                        </div>
                        <button
