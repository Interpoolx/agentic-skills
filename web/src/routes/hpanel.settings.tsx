...
function getProjectLinks() {
    ...
    return {
        npm: localStorage.getItem('project_npm_url') || BRANDING.npm_url,
        vscode: localStorage.getItem('project_vscode_url') || BRANDING.vscode_url,
        github: localStorage.getItem('project_github_url') || `https://github.com/${BRANDING.github_org}/${BRANDING.github_repo}`,
    }
}
                ...
                <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div className="flex items-center gap-4 p-4 bg-gray-700/50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-400">admin@${BRANDING.domain_name}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between py-2 border-b border-gray-700">
                            ...
                            <span className="text-white">${BRANDING.brand_lower_name}-skills-db</span>
                        </div>
